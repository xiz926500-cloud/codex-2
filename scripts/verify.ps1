...
Assert-File "config\codex-sol-only\AGENTS.md"
Assert-File "config\codex-sol-only\config.toml"
Assert-File "docs\CODEX_ENVIRONMENT_RESTORE.md"
...
Assert-File "scripts\apply-sol-only-codex.ps1"
...
Assert-File "scripts\restore-codex-skills.ps1"
...
Assert-File "scripts\verify-sol-only-codex.ps1"
...
Assert-Directory "config\codex-sol-only"
